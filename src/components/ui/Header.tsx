...
const Header = () => {
  ...
  return (
    <header
      className={cn(
        "mb-5 backdrop-filter  transition duration-200 ease-in-out z-50 m-auto place-items-center p-5 font-serif w-full",
        isSticky ? "bg-white/50 sticky top-0 shadow-md backdrop-blur-md" : ""
      )}
    >
      {" "}
      <svg
      ...
      <div
        className={cn(
          "w-1/2 flex items-center text-sm text-gray-800 before:flex-1  before:border-gray-200 before:me-6 after:flex-1  after:border-gray-200 after:ms-6",
          isSticky ? "" : "before:border-t after:border-t"
        )}
      >
